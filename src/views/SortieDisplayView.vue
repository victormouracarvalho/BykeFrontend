  ...
  <div>
    <div class="container">
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" id="arrival" class="form-control" aria-label="Default"
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" id="bikeId" class="form-control" aria-label="Default"
               aria-describedby="inputGroup-sizing-default">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" id="departure" class="form-control" aria-label="Default"
               aria-describedby="inputGroup-sizing-default">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" id="id" class="form-control" aria-label="Default"
               aria-describedby="inputGroup-sizing-default">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" id="start" class="form-control" aria-label="Default"
               aria-describedby="inputGroup-sizing-default">
      </div>
    </div>
...
export default {
  ...
  async created() {
    ...
    this.steps = this.excursions.path.steps.map(step => ({
